...
class SeoModel extends ComponentBase
{
	...
	{
		return [
			'name'			=> 'zmark.seo::lang.component_seomodel.name',
			'description'	=> 'zmark.seo::lang.component_seomodel.description'
		];
	}
    ...
    public function defineProperties()
    {
        return [
            'pageType' => [
                'title' => 'zmark.seo::lang.component_seomodel.property_pageType.title',
                'description' => 'zmark.seo::lang.component_seomodel.property_pageType.description',
                'default' => '',
                'required' => true,
            ],
            'pageProperty' => [
                'title' => 'zmark.seo::lang.component_seomodel.property_pageProperty.title',
                'description' => 'zmark.seo::lang.component_seomodel.property_pageProperty.description',
                'default' => '',
                'required' => true,
            ],
        ];
    ...
    public function onRun()
    {
        ...
        $seo = \Zmark\Seo\Models\Seo::where('type', $this->property('pageType'))
        ...
        if (!$seo || empty($seo->image)) {
            $seo_default_values = Event::fire('zmark.seo.mapSeoData', [$this->property('pageType'), $this->page[$this->property('pageProperty')]->getKey()], true);

            if ($seo_default_values) {
                $seo_defaults = new \Zmark\Seo\Models\Seo;
