...
use Zmark\Seo\Models\Sitemap as SitemapModel;
...
class Sitemap extends Controller
{
    ...
    public $requiredPermissions = ['zmark.seo.sitemap'];
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Zmark.Seo', 'seo', 'sitemap');

        $this->addJs('/modules/backend/assets/js/october.treeview.js', 'core');
        $this->addJs('/plugins/zmark/seo/assets/js/sitemap-definitions.js');
    }
    ...
    protected function redirectToThemeSitemap($theme)
    {
        ...
        $updateUrl = sprintf('zmark/seo/sitemap/update/%s', $model->getKey());
